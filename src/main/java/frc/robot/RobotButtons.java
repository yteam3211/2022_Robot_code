...
public class RobotButtons {
    ...
    public void loadButtons(DriveSystem driveSystem,ShootingSystem shoot, collectSelnoid collectSelnoid, CartridgeSystem cartridge, CollectSystem collect, ClimbSystem climbSystem, ExpandedClimbSystem expandedClimbSystem) {
        shootHighButton.whileActiveOnce(new ShootingCommand(shoot, cartridge, driveSystem, true, false));// (new
        shootLowButton.whileActiveOnce(new ShootingCommand(shoot, cartridge, driveSystem, false, false));// (new
        ...
        climbExpandedClose.whileActiveOnce(new SetOutputCommand(expandedClimbSystem, 0.9));
        climbExpandedOpen.whileActiveOnce(new SetOutputCommand(expandedClimbSystem, -0.9));
