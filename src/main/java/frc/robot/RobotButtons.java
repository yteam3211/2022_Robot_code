...
public class RobotButtons {
    ...
    public void loadButtons(DriveSystem driveSystem,ShootingSystem shoot, collectSelnoid collectSelnoid, CartridgeSystem cartridge, CollectSystem collect, ClimbSystem climbSystem, ExpandedClimbSystem expandedClimbSystem, Limelight limelight) {
        shootHighButton.whileActiveOnce(new ShootingCommand(shoot, cartridge, driveSystem, gains.high, false));// (new
