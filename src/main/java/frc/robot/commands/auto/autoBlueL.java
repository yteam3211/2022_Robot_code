...
public class autoBlueL extends AutoGenerator {
    public autoBlueL(DriveSystem driveSystem, SuperNavX navX) {
            super("autoBlueL", driveSystem.getAutoGains(), driveSystem, navX);
