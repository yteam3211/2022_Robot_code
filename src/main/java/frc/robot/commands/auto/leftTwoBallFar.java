...
public class leftTwoBallFar extends AutoGenerator {
  public leftTwoBallFar(DriveSystem driveSystem, SuperNavX navX, CollectSystem collectSystem, CartridgeSystem cartridgeSystem, collectSelnoid collectSelnoid, ShootingSystem shootingSystem) {
          ...
          addCommands(new ParallelRaceGroup(new TimeCommand(2500), new TurnInPlace(driveSystem, navX, 180)), new changeSelenoidCommand(collectSelnoid, false));
          addCommands(new ParallelDeadlineGroup(addFollowPathCommand(Constants.LTB3, new EncoderDriveControl(driveSystem)),new changeSelenoidCommand(collectSelnoid, false)));
