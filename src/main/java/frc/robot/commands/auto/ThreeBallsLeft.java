...
public class ThreeBallsLeft extends AutoGenerator {
    public ThreeBallsLeft(DriveSystem driveSystem, SuperNavX navX, CollectSystem collectSystem,
        ...
        addCommands(new ParallelRaceGroup(new TimeCommand(2000), new TurnInPlace(driveSystem, navX, 340, 0.7), new changeSelenoidCommand(collectSelnoid, false)));
