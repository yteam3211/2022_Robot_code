...
public class ThreeBallFar extends AutoGenerator {
    public ThreeBallFar(DriveSystem driveSystem, SuperNavX navX, CollectSystem collectSystem,
        ...
        addCommands(new ParallelDeadlineGroup(addFollowPathCommand(Constants.TP1, new EncoderAndNavxDriveControl(driveSystem, navX)),new CloseCollectCommand(collectSystem, true)));
        addCommands(new ParallelRaceGroup(new TimeCommand(2500), new TurnInPlace(driveSystem, navX, 320)));
        ...
        addCommands(addFollowPathCommand(Constants.TP3, new EncoderAndNavxDriveControl(driveSystem, navX)));
